                ...
                <div className="max-w-7xl mx-auto space-y-20">
                    ...
                    <div className="text-center space-y-4">
                        <h2 className="text-4xl sm:text-5xl font-bold text-[#234e18]">
                            About <span className="text-[#1d1449]">Noor Public School</span>
                        </h2>
                        <p className="text-lg text-[#67607e] max-w-3xl mx-auto leading-relaxed">
                            We are dedicated to providing modern education blended with
                            strong moral, ethical, and Islamic values. Empowering students to
                            excel in academics and character!
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
                            {/* Vision */}
                            <div className="bg-gradient-to-br from-white via-[#f0f7f2] to-[#e7f3e9] rounded-2xl shadow-lg border-l-[6px] border-[#94c484] p-6 hover:scale-[1.02] transition duration-300">
                            ...
                            {/* Mission */}
                            <div className="bg-gradient-to-br from-white via-[#f4f3f9] to-[#ebebf2] rounded-2xl shadow-lg border-l-[6px] border-[#5f5971] p-6 hover:scale-[1.02] transition duration-300">
                                <div className="flex items-center gap-3 mb-4">
                            ...
                            {/* Core Values */}
                            <div className="bg-gradient-to-br from-white via-[#fdfaf4] to-[#faf5ed] rounded-2xl shadow-lg border-l-[6px] border-[#c3ad74] p-6 hover:scale-[1.02] transition duration-300">
                                <div className="flex items-center gap-3 mb-4">
                            ...
                            {/* Discipline */}
                            <div className="bg-gradient-to-br from-white via-[#f0f4f7] to-[#e3edf2] rounded-2xl shadow-lg border-l-[6px] border-[#7eadc9] p-6 hover:scale-[1.02] transition duration-300">
                                <div className="flex items-center gap-3 mb-4">
                            ...
                            {/* Foundation */}
                            <div className="bg-gradient-to-br from-white via-[#f3f3f3] to-[#eaeaea] rounded-2xl shadow-lg border-l-[6px] border-[#cf6363] p-6 hover:scale-[1.02] transition duration-300">
                                <div className="flex items-center gap-3 mb-4">
