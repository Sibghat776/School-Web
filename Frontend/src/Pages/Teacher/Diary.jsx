...
import { Loading, EmptyState, ErrorState, PanelCard, Button, Input, Textarea } from '../../Components/ui';
      ...
      {showForm && (
        <PanelCard title="New Diary Entry">
          <form onSubmit={create} className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <Textarea name="description" value={form.description} onChange={onChange} placeholder="Homework / description" className="md:col-span-2" required />
